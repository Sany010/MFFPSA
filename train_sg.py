...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        #csd = ckpt.float().state_dict()  # checkpoint state_dict as FP32无预训练
...
def parse_opt(known=False):
    ...
    #parser.add_argument('--weights', type=str, default='/root/autodl-tmp/cspsg-master/runs/train/exp209/weights/best.pt', help='initial weights path')
