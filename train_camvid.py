...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        #csd = ckpt['model'].float().state_dict()    #ckpt['model'].float().state_dict()  # checkpoint state_dict as FP32
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='/root/autodl-tmp/cspsg-master/runs/train/exp294/weights/81.pt', help='initial weights path')
    ...
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=704, help='train, val image size (pixels)')
