...
if __name__ == '__main__':
    ...
    convert32to11(label_dir='/root/autodl-tmp/cspsg-master/datasets/camvid/LabeledApproved_full/*',
                  save_dir='/root/autodl-tmp/cspsg-master/datasets/camvid/CamVidGray')
    quit()
