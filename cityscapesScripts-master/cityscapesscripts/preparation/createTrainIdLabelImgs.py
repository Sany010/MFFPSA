...
#sys.path.append('/root/autodl-tmp/cityscapesScripts-master/cityscapesscripts')
# cityscapes imports
...
def main():
    ...
    #CITYSCAPES_DATASET = '/root/autodl-tmp/cspsg-master/datasets/cityscapes'
    #if 'CITYSCAPES_DATASET' in os.environ:
     #   cityscapesPath = os.environ['CITYSCAPES_DATASET']
    #else:
     #   cityscapesPath = os.path.join(os.path.dirname(os.path.realpath(__file__)),'..','..')
    # how to search for all ground truth
    cityscapesPath = '/root/autodl-tmp/cspsg-master/datasets/cityscapes'
