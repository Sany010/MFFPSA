...
class LoadImagesAndLabels_sg_cam(Dataset):
    ...
    def __init__(self, path, phase, size=None, hyp=None):
        ...
        for l in lines:
            ...
            new_list1 = ['/root/autodl-tmp/cspsg-master/datasets/CamVid/' + l1]
            new_list2 = ['/root/autodl-tmp/cspsg-master/datasets/CamVid/' + l2]
            self.image_path.extend(new_list1)
            self.label_path.extend(new_list2)
        f.close()
